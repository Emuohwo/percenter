...
function MainAppBar() {
    ...
    const renderMobileMenu = (
        ...
        >
            ...
            <MenuItem>
              <IconButton aria-label="show 11 new notification" color="inherit">
            ...
            <AppBar position="static">
              <Toolbar>
                ...
                <div className={classes.sectionDesktop}>
                    ...
                    {/* appbar link ends */}
                    <IconButton aria-label="show 4 mails" color="inherit">
                        <Badge badgeContent={4} color="secondary">
                        <NotificationsIcon />
                        </Badge>
                    </IconButton>
                    <IconButton aria-label="show 17 new notification" color="inherit">
